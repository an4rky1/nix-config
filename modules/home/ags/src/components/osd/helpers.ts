...
import { GdkMonitorService } from '../../services/display/monitor';
...
export const revealerSetup = (self: Widget.Revealer): void => {
    ...
    hook(self, enable, handleReveal);
    hook(self, brightnessService, 'notify::screen', handleReveal);
    hook(self, brightnessService, 'notify::kbd', handleReveal);
