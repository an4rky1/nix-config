...
import AstalHyprland from '../../services/niri';
import { Bar } from '../../components/bar';
import { forMonitors } from '../../components/bar/utils/monitors';
import { DropdownMenus, StandardWindows } from '../../components/menus';
import { handleRealization } from '../../components/menus/shared/dropdown/helpers/helpers';
import Notifications from '../../components/notifications';
import OSD from '../../components/osd/index';
import { isDropdownMenu } from '../../components/settings/constants.js';
import { SettingsDialogLoader } from '../../components/settings/lazyLoader';
import options from '../../configuration';
import { initializeSystemBehaviors } from '../behaviors';
import { JSXElement } from '../types';
import { Timer } from '../../lib/performance/timer';
import { BarRefreshManager } from '../../services/display/bar/refreshManager';
