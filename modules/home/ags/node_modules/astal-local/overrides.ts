...
function initOverrides() {
    suppress(import("gi://AstalApps"), ({ Apps, Application }) => {
    ...
    suppress(import("gi://AstalBluetooth"), ({ Adapter, Bluetooth, Device }) => {
    ...
    suppress(import("gi://AstalMpris"), ({ Mpris, Player }) => {
    ...
    suppress(import("gi://AstalNetwork"), ({ Wifi }) => {
        patch(Wifi.prototype, "access_points")
        patch(Wifi.prototype, "accessPoints")
    })

    suppress(import("gi://AstalNotifd"), ({ Notifd, Notification }) => {
        patch(Notifd.prototype, "notifications")
        patch(Notification.prototype, "actions")
    })

    suppress(import("gi://AstalPowerProfiles"), ({ PowerProfiles }) => {
        patch(PowerProfiles.prototype, "actions")
    })

    suppress(import("gi://AstalWp"), ({ Wp, Audio, Video, Node, Endpoint, Device }) => {
